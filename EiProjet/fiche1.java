...
public class fiche1 {
	public static void fiche1xml(String txtFile) throws Exception{
		...
		org.w3c.dom.Document doc = domimp.createDocument(null,"FICHES",dtd);//
		doc.setXmlStandalone(true);
	
		
		Element rac = doc.getDocumentElement(); 
		org.w3c.dom.ProcessingInstruction pi = doc.createProcessingInstruction("xml-stylesheet", "href=\"test.xsl\" type=\"text/xsl\"");
		...
		{ 
			...
			if ((counter >= 0& counter<=1)  | counter == 4){
				...
				h2=balise;
				     ...
				     ele2.appendChild((doc.createTextNode(h2+" : "+medecin))); 
				 	 ele2 = doc.createElement(h2);    
				     rac.appendChild(ele2);
				     ele1.appendChild(ele2);
				     lang.appendChild(ele2);
				     ele2.appendChild((doc.createTextNode(h+" : "+auteur))); 	 
			...
			if ((counter >= 29& counter<=30)  | counter == 33){
				...
				h2=balise;
				     ...
				     lang.appendChild(ele2);
				     ele2.appendChild((doc.createTextNode(h+" : "+auteur))); 
					//System.out.println("traitement AR");
					// on va creer le AR 	 
		...
		tr.transform(ds, res);  
		System.out.println("Le fichier fiches.txt est transformer avec succes \"fiche1.xml\" ");   
		}
}
