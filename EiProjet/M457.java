...
public class M457 {
	  public static void M457xml(String xmlFile) throws Exception{
			//Corriger les erreurs et utiliser un fichier intermédiare valide
		    ...
		    Document document_src = one_parser.parse(xmlFile);
		    ...
		    StreamResult res = new StreamResult(new File("sortie2.xml"));
